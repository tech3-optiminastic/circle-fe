...
function ratingLabel(r: number): { text: string; cls: string } {
  ...
  return { text: 'Unrated', cls: 'text-gray-400 bg-[#F1F1F2]' };
}
  ...
  return (
    <div className="space-y-6 select-none">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
        ...
        <span className="text-[11px] font-mono text-gray-500 bg-[#F1F1F2] px-2.5 py-1 rounded-md w-fit">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {active.map(emp => {
          ...
          return (
            <div key={emp.id} className="bg-[#FFFFFF] border border-[#EAEAEC] rounded-xl p-4 space-y-3">
