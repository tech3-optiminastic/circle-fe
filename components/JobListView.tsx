          ...
          {jobs.map(job => {
            ...
            return (
              <div
                ...
                className="bg-white border border-[#E1D6BC] rounded-2xl p-4 shadow-2xs flex flex-col gap-3 hover:border-accent-300 hover:shadow-sm transition cursor-pointer"
