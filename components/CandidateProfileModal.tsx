          ...
          {activeTab === 'evaluation' && (
            <div className="flex-1 p-6 space-y-6 overflow-y-auto">
              ...
              <div className="bg-[#FFFFFF] border border-[#E1D6BC] rounded-xl p-5 space-y-4">
                <div className="border-b border-[#E1D6BC]/65 pb-2">
                  <h3 className="text-xs font-bold text-gray-900 uppercase tracking-wider font-mono">
                ...
                {candidateEvents.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {candidateEvents.map(ev => (
                      <span
                        key={ev.id}
                        className="flex items-center gap-1.5 text-[10px] font-mono font-semibold bg-[#F7F1E4] border border-[#E1D6BC] text-gray-700 px-2.5 py-1.5 rounded-lg"
                      >
                  ...
                  <div className="space-y-2">
                    {candidateTests.map(t => {
                      ...
                      return (
                        <div
                          key={t.id}
                          className="flex flex-wrap items-center gap-x-4 gap-y-2 border border-[#E1D6BC] bg-[#F7F1E4] rounded-lg px-3.5 py-2.5"
                        >
                          ...
                          {finished ? (
                            <button
                              ...
                              className="text-[10px] bg-white border border-[#E1D6BC] text-gray-700 hover:text-accent-600 hover:border-accent-300 px-2 py-1 rounded-md font-semibold font-mono flex items-center gap-1 cursor-pointer transition shadow-2xs"
                            >
