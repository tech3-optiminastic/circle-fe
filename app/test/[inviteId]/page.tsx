  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden bg-gradient-to-b from-[#F6F7F9] to-[#E4E6EA]">
      ...
      <header className="relative z-10 flex items-center justify-between px-5 py-4">
        ...
        <span className="hidden items-center gap-1.5 rounded-full border border-[#E4E6EA] bg-white/60 px-3 py-1 text-[10px] font-semibold text-gray-600 sm:inline-flex">
