...
function TestFlow({ invite }: { invite: TestInvite }) {
    ...
    return (
      <Shell>
        <div className="flex flex-col items-center gap-4 py-14 text-center px-6">
          ...
          <div className="bg-white border border-[#E1D6BC] rounded-2xl px-8 py-5 shadow-2xs">
      ...
      <Shell>
        <div className="px-6 py-10 max-w-xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            <div className="bg-white border border-[#E1D6BC] rounded-xl py-3.5">
          ...
          <div className="bg-[#FDF6EC] border border-[#E1D6BC] rounded-2xl p-5 space-y-3">
  ...
  /* --------------------------- running ----------------------------- */
  return (
    <div className="min-h-screen bg-[#F0E7D5] select-none">
      {/* Sticky proctor bar */}
      <div className="sticky top-0 z-50 bg-[#212842] text-white px-4 py-2.5 flex items-center justify-between gap-3">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4 pb-28">
        {questions.map((q, i) => (
          <div
            key={q.id}
            className="bg-white border border-[#E1D6BC] rounded-2xl p-4 sm:p-5 shadow-2xs"
          >
                  ...
                  <button
                    ...
                    className={`text-left text-[12.5px] px-3 py-2.5 rounded-lg border transition cursor-pointer ${
                      selected
                        ...
                        : 'border-[#E1D6BC] text-gray-600 hover:bg-[#F7F1E4]'
                    }`}
                  >
      ...
      {/* Submit bar */}
      <div className="fixed bottom-0 inset-x-0 bg-white/95 backdrop-blur border-t border-[#E1D6BC] px-4 py-3">
...
function Shell({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[#F0E7D5] flex flex-col">
      <header className="bg-[#212842] px-5 py-3.5 flex items-center gap-2.5">
        <Logo size={26} />
        <div>
