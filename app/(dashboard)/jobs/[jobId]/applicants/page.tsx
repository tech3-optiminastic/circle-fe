...
export default function JobApplicantsPage() {
  ...
  if (!job) {
    return (
      <div className="bg-white border border-dashed border-[#CDBE9C] rounded-2xl py-16 flex flex-col items-center gap-3 text-center px-6 text-xs">
  ...
  return (
    <div className="space-y-4">
      {/* Job context banner */}
      <div className="bg-white border border-[#E1D6BC] rounded-2xl px-4 py-3.5 shadow-2xs flex flex-col sm:flex-row sm:items-center gap-3 text-xs select-none">
        <Link
          href="/jobs"
        ...
        <span className="hidden sm:block w-px h-8 bg-[#EAE1CC]" />
